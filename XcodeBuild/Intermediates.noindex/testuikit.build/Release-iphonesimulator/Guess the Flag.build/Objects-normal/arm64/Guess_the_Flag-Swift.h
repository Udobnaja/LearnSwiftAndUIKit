...
#ifndef GUESS_THE_FLAG_SWIFT_H
#define GUESS_THE_FLAG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Guess_the_Flag",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14Guess_the_Flag11AppDelegate")
...
SWIFT_CLASS("_TtC14Guess_the_Flag13SceneDelegate")
...
SWIFT_CLASS("_TtC14Guess_the_Flag14ViewController")
@interface ViewController : UIViewController
- (void)loadView;
- (void)viewDidLoad;
- (void)scoreTappedWithSender:(UIButton * _Nonnull)sender;
