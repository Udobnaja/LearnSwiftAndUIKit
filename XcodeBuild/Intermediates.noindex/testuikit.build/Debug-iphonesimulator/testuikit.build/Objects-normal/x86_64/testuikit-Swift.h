...
#ifndef TESTUIKIT_SWIFT_H
#define TESTUIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="testuikit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9testuikit11AppDelegate")
...
SWIFT_CLASS("_TtC9testuikit20DetailViewController")
@interface DetailViewController : UIViewController
- (void)loadView;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (void)shareTappedWithSender:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC9testuikit13SceneDelegate")
...
SWIFT_CLASS("_TtC9testuikit14ViewController")
